...
const Cutting = ({ cart, setCart }) => {
  ...
  const handleAddToCart = () => {
    const programToAdd = {
      name: '15-Week Custom Cutting Program',
      quantity: quantity,
    };
        ...
        <Row className="justify-content-center mt-5">
          <Col xs={12} md={8} lg={7}>
            <h1 className="display-4 text-center mb-4" style={{ fontSize: '4rem', lineHeight: '1.2', fontStyle: 'italic' }}>
              15-Week Custom Cutting Program
            </h1>
            <Row>
              ...
              <Col xs={20} md={10}>
                ...
                <ul>
                  ...
                  <li>
                    Unlock the secrets of successful Cutting with this in-depth guide designed to maximize fat loss while keeping muscle mass. Follow the step-by-step guide to ensure optimal results throughout the 15-week training program.
                  </li>
                  <li>
